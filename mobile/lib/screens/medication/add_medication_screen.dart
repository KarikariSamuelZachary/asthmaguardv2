...
class _AddMedicationScreenState extends State<AddMedicationScreen> {
  ...
  void _populateFields() {
    ...
    _startDate =
        med.startDate != null ? DateTime.parse(med.startDate!) : DateTime.now();
    _endDate = med.endDate != null ? DateTime.parse(med.endDate!) : null;
    _active = med.active;
  }
  ...
  void _saveMedication() async {
    ...
    try {
      final medication = Medication(
        id: widget.medication?.id ?? UniqueKey().toString(),
